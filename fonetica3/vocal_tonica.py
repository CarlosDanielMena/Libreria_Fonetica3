...
def vocal_tonica(palabra_in):
	...
	if acabo == False:
		...
		#Termina en: az, ez, iz, oz, uz
		word = word.replace("az#","Az")	
		word = word.replace("ez#","Ez")
		word = word.replace("iz#","Iz")
		word = word.replace("oz#","Oz")
		word = word.replace("uz#","Uz")

		#Terminaciones varias
		word = word.replace("ion#","iOn")
		word = word.replace("ad#","Ad")
		word = word.replace("id#","Id")
		word = word.replace("ud#","Ud")
